...
<div align="center">
Implements custom boot animations in `.zip` format on Samsung devices with Magisk/KernelSU as its root solution/method.
...
|-------|---------|----------|
| **test** | <img src="previews/video2.gif" alt="cyanogenmod" width="160"> | [android-bootfx-3.0.3-magisk.zip](https://github.com/John0n1/SMbootFX/releases/download/3.0.3/android-bootfx-3.0.3-magisk.zip) |  |
